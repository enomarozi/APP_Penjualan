...
$id = $_GET['id'];
$row = $db->query("SELECT * FROM pembelian WHERE id=?",[$id]);
if(count($row) === 0){
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title"><i class="bi bi-plus-circle"></i> Edit Data Pembelian</h5>
      ...
      <form id="formEdit" method="POST">
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="layanan_produk" class="form-control" placeholder="Ganti Oli / Ban / Sparepart / dll" value="<?= $data['layanan_produk'];?>" required>
          </div>
